...
//                   <div
//                     key={category._id}
//                     className="flex flex-col sm:flex-row items-center justify-between p-4 border border-border rounded-md hover:bg-accent/5 transition-all duration-200"
//                   >
...
//       {/* Error Message */}
//       {error && (
//         <div className="fixed bottom-4 right-4 bg-destructive/10 text-destructive p-4 rounded-xl shadow-lg flex items-center gap-3 animate-slide-up border border-destructive/20">
...
//                       <p>
//                         This category has {deleteWarning.subcategoriesCount}{" "}
//                         subcategories
//                       </p>
//                     </div>
//                   )}
...
//                     <div className="bg-accent/5 p-3 rounded-lg">
//                       <p>
//                         This category contains {deleteWarning.itemsCount} items
//                       </p>
//                     </div>
//                   )}
//                   <p className="text-base">
//                     Deleting this category will also delete all its
//                     subcategories and associated items.
//                   </p>
//                 </div>
//               </div>
//               <div className="mt-6 p-4 border border-border/20 dark:border-border/40 rounded-lg bg-accent/5">
...
//                     className="w-5 h-5 rounded border-2 border-destructive/30 text-destructive focus:ring-destructive"
//                   />
        ...
        <div className="flex-1">
          ...
          <div className="space-y-3 text-muted-foreground">
            {selectedCategory?.hasSubcategories && (
              <div className="bg-accent/5 p-3 rounded-lg">
                <p>This category has {selectedCategory.subcategoriesCount} subcategories</p>
              </div>
            )}
            {selectedCategory?.hasItems && (
              <div className="bg-accent/5 p-3 rounded-lg">
                <p>This category contains {selectedCategory.itemsCount} items</p>
              </div>
            )}
            <p className="text-base">
