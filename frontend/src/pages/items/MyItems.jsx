  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {filteredAds.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredAds.map((ad) => (
            <div key={ad._id} className="border rounded-lg p-4 bg-white">
              <div className="flex items-start gap-4">
                {/* Ad Image */}
                <div className="w-32 h-32 bg-gray-200 rounded-md overflow-hidden">
                  {ad.images?.[0]?.url && (
                    ...
                    <div>
                      ...
                      <p>
                          {typeof ad.location === 'object' 
                            ? ad.location?.address || 'Location not specified'
                            : ad.location || 'Location not specified'}
                        </p>
                      </div>
                      <p className="text-lg font-semibold mt-2">
  Rs {typeof ad.price === 'object' ? ad.price.amount || '0' : ad.price.toLocaleString()}
</p>
                    </div>
                    <div className="flex items-center gap-2">
                      <Button 
